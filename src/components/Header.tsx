        ...
        {isAccountOpen && (
          <>
            ...
            <motion.div 
              ...
              className="absolute top-16 left-4 right-4 sm:left-auto sm:right-6 sm:w-96 bg-white rounded-[2rem] shadow-2xl border border-slate-100 p-6 z-50 overflow-hidden"
            >
              ...
              <div className="space-y-5">
                <div className="rounded-[1.5rem] border border-slate-100 p-4">
                  ...
                  <select
                    ...
                    className="w-full rounded-2xl border border-slate-200 px-4 py-3 text-sm text-slate-900 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100 outline-none"
                  >
                      ...
                      <div className="flex items-center gap-2">
                        {['csv', 'pdf'].map((format) => (
                          <button
                            ...
                            className={`flex-1 rounded-full px-4 py-3 text-sm font-semibold transition ${exportFormat === format ? 'bg-indigo-600 text-white' : 'bg-slate-100 text-slate-600 hover:bg-slate-200'}`}
                          >
                            {format.toUpperCase()}
                          </button>
                        ))}
